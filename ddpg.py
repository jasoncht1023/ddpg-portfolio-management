...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, fc1_dims, fc2_dims, n_actions, name, chkpt_dir='tmp/ddpg'):
        ...
        self.bn1 = nn.LayerNorm(self.fc1_dims)          # bn = batch normalisation
    ...
    def forward(self, state, action):
        ...
        state_action_value = F.relu(T.add(state_value, action_value)) # might need to change, relu then add vs add then relu
